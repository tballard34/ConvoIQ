 ...
 */
export async function generateComponentTitle(apiKey, prompt, structuredOutput, uiCode) {
 ...
 */
export async function generateConversationTitle(apiKey, readableTranscript) {
 ...
 */
export async function generateDashboardTitle(apiKey, componentTitles) {
